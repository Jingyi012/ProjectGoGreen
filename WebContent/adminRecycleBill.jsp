...
<title>GoGreen</title>
<link rel="stylesheet" href="./css/billCalendar.css" />
</head>
<body>
	<div class="pageContainer">
        ...
        <div class="pageWrapper">
        	...
        	<div class="pageNav">
					Home > 
					<a href="validateBill.jsp">Validate Bill</a> >
					...
					<div class="month">
        				...
        				<div class="monthFunc">
							<%
							   if(i+1 < currentMonth){
							%>
								<a class="uploadBtn" href="./recycleMonthForm.jsp?month=<%=monthArray[i]%>">Validate</a>
							<%   
								}
							%>
        				</div>
