				...
				<div class="formContainer">
					<form action="${pageContext.request.contextPath}/bills/editElectricMonthForm/submit" method="post" enctype="multipart/form-data">
						<div class="billForm electric">
							<label for="eBill" class="form-label">Insert Electric Consumption(kWh):</label>
							<input type="text" id="eBill" class="form-control" name="eBill" placeholder="123" value="${electricbill.electric_consumption}" required>
						</div>
						
						<div class="billFile electric">
							<label class="form-label">Upload Electric Bill as proof:</label>
							<input type="file" id="eFile" class="form-control" name="eFile" accept="image/*" placeholder="Choose file" required aria-describedby="fileHelp">
