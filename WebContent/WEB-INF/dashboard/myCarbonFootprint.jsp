...
<body>
	...
	<div class="detailItemBlock">
		...
		<span class="consumption electric"> 
			...
			<span> ${electric_consumption} kWh</span>
		</span>
	</div>
	...
	<div class="detailItemBlock carbonFootprint">
		...
		<span class="consumption"> 
			<img src="${pageContext.request.contextPath}/resources/images/carbonFootprint.png" alt="carbonFootprint.png" width="25px" /> 
			<span>${carbon_footprint} kgCO<sub>2</sub></span>
		</span>
	</div>
</body>
</html>