				...
				<div class="formContainer">
					<form action="${pageContext.request.contextPath}/bills/editWaterMonthForm/submit" method="post" enctype="multipart/form-data">
						<div class="billForm water">
							...
							<input type="text" id="wBill" class="form-control" name="wBill" placeholder="123" value="${waterbill.water_consumption}" required>
						</div>
...
<script>
    document.getElementById('wFile').addEventListener('change', function() {
