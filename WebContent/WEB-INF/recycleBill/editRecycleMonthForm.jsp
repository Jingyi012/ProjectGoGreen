				...
				<div class="formContainer">
					<form action="${pageContext.request.contextPath}/bills/editRecycleMonthForm/submit" method="post" enctype="multipart/form-data">
						<div class="billForm recycle">
							...
							<input type="text" id="recycle_weight" class="form-control" name="recycle_weight" placeholder="123" value="${recycleBill.recycle_weight}" required>
						</div>
						
						<div class="billFile recycle">
							<label class="form-label">Upload Recycling Bill as proof:</label>
							<input type="file" id="rFile" class="form-control" name="rFile" accept="image/*" placeholder="Choose file" required aria-describedby="fileHelp">
