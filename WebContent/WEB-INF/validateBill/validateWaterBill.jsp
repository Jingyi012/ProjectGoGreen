        ...
        <div class="pageWrapper">
        	...
        	<div class="pageContent">
				<div class="pageNav">
					...
					<a href="">Validate Water Bill</a>
				</div>

	        	<h2 style="text-decoration: underline; font-size: 30px; margin: 20px 0" >Validate Water Bill</h2>
	        	<div class="waterBillTableContainer">
	        		<table class="table table-hover">
	        			...
	        			<tr>
	        				...
	        				<td><c:out value="${wuList.getName()}" /> </td>
	        				<td><c:out value="${wuList.address}" /> </td>
	        				<td><c:out value="${wuList.category}" /> </td>
							...
							<div class="modal fade" id="wbillModal${wuList.waterId}" tabindex="-1" aria-labelledby="#wbillModalLabel" aria-hidden="true">
							  <div class="modal-dialog">
							    <div class="modal-content">
							      <div class="modal-header">
							        <h1 class="modal-title fs-5" id="wbillModalLabel">View Bill</h1>
							        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
							      </div>
							      <div class="modal-body" style="text-align: center;">
							      <!-- display image -->
							      	<img class="billImg" width="400px" src="data:image/*;base64,${Base64.getEncoder().encodeToString(wuList.water_proof)}" alt="Image" />
	        				...
	        				<td>
	        					<form method="post" action="validateWaterAction">
	        						<input type="hidden" name="waterId" value="${wuList.waterId}" />
