        ...
        <div class="pageWrapper">
        	...
        	<div class="pageContent">
				<div class="pageNav">
					...
					<a href="">Validate Recycle Bill</a>
				</div>

	        	<h2 style="text-decoration: underline; font-size: 30px; margin: 20px 0" >Validate Recycle Bill</h2>
	        	<div class="recycleBillTableContainer">
	        		<table class="table table-hover">
	        			...
	        			<tr>
	        				...
	        				<td><c:out value="${ruList.getName()}" /> </td>
	        				<td><c:out value="${ruList.address}" /> </td>
	        				<td><c:out value="${ruList.category}" /> </td>
							...
							<div class="modal fade" id="ebillModal${ruList.rid}" tabindex="-1" aria-labelledby="#ebillModalLabel" aria-hidden="true">
							  <div class="modal-dialog">
							    <div class="modal-content">
							      ...
							      <!-- display image -->
							      	<img class="billImg" width="400px" src="data:image/*;base64,${Base64.getEncoder().encodeToString(ruList.recycleBill_proof)}" alt="Image" />
	        				...
	        				<td>
	        					<form method="post" action="validateRecycleAction">
	        						<input type="hidden" name="rid" value="${ruList.rid}" />
