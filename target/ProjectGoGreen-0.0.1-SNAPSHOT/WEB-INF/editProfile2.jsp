            ...
            <div class="pageContent">
				...
				<form action="#" method="post">
					<div class="left">
					    ...
					    <input type="text" id="input1" name="input1" value="Ali"><br>
					
					    <label for="input2">Phone Number:</label><br>
					    <input type="text" id="input2" name="input2" value="01112028239"><br>
					
					    <label for="input3">Category:</label><br>
					    <input type="text" id="input3" name="input3" value="Housing(High Rise)"><br>
					
					    <label for="input4">Address:</label><br>
					    <input type="text" id="input4" name="input4" value="Loring 4d, No.12 Taman Buaya"><br>
					
					    <label for="input5">Area:</label><br>
					    <select name="area" id="input5" class="selectArea">
				    ...
				    <div class="right">
					    ...
					    <input type="text" id="input6" name="input6" value="Zhen"><br>
					
					    <label for="input7">Email:</label><br>
					    <input type="text" id="input7" name="input7" value="abc123@gmail.com"><br>
					
					    <label for="input8">Number of People Living In The House:</label><br>
					    <input type="text" id="input8" name="input8" value="2"><br>
				    ...
				    <div class="submitContainer">
	                    <input type="button" id="btn" value="Submit" onclick="redirectToOtherPage()">
	                </div>
		        ...
		        function redirectToOtherPage() {
		            ...
		            window.location.href = 'profile2.jsp'; 
		        }
	    		</script>
